...
function RouterFunction($stateProvider){
  ...
  .state("homePage", {
    url: "/",
    templateUrl: "/assets/ng-views/home-views/bac_calculator.html",
    controller: "HomePageController",
    controllerAs: "vm"
  })
  .state("breweryIndex", {
    url: "/breweries",
    templateUrl: "/assets/ng-views/breweries/brewery-index.html",
    controller: "BreweryIndexController",
    controllerAs: "vm"
  })
  .state("beerIndex", {
    url: "/beers",
    templateUrl: "/assets/ng-views/beers/beer-index.html",
    controller: "BeerIndexController",
    controllerAs: "vm"
  })
  .state("breweryShow", {
    url: "/breweries/:id",
    templateUrl: "/assets/ng-views/breweries/brewery-show.html",
    controller: "BreweryShowController",
    controllerAs: "vm"
  })
  .state("beerShow", {
    url: "/beers/:id",
    templateUrl: "/assets/ng-views/beers/beer-show.html",
    controller: "BeerShowController",
    controllerAs: "vm"
  })
  .state("beerPercent", {
    url: "/beerpercent",
    templateUrl: "/assets/ng-views/home-views/beer-percent.html",
    controller: "BeerPercentController",
    controllerAs: "vm"
  })
  .state("beerIbu", {
    url: "/beer-ibu",
    templateUrl: "/assets/ng-views/home-views/beer-ibu.html",
    controller: "BeerIbuController",
    controllerAs: "vm"
  })
  .state("commentIndex", {
    url: "/comments",
    templateUrl: "/assets/ng-views/comment/comment-index.html",
    controller: "CommentIndexController",
    controllerAs: "vm"
  })
  .state("commentShow", {
    url: "/comments/:id",
    templateUrl: "/assets/ng-views/comment/comment-show.html",
